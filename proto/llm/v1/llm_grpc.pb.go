...
const (
	...
	LLMService_IngestILOData_FullMethodName    = "/llm.v1.LLMService/IngestILOData"
)
...
type LLMServiceClient interface {
	...
	IngestILOData(ctx context.Context, in *IngestILODataRequest, opts ...grpc.CallOption) (*IngestILODataResponse, error)
}
...
func (c *lLMServiceClient) IngestILOData(ctx context.Context, in *IngestILODataRequest, opts ...grpc.CallOption) (*IngestILODataResponse, error) {
	out := new(IngestILODataResponse)
	err := c.cc.Invoke(ctx, LLMService_IngestILOData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LLMServiceServer interface {
	...
	IngestILOData(context.Context, *IngestILODataRequest) (*IngestILODataResponse, error)
...
func (UnimplementedLLMServiceServer) IngestILOData(context.Context, *IngestILODataRequest) (*IngestILODataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IngestILOData not implemented")
}
...
func _LLMService_IngestILOData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IngestILODataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LLMServiceServer).IngestILOData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LLMService_IngestILOData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LLMServiceServer).IngestILOData(ctx, req.(*IngestILODataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LLMService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IngestILOData",
			Handler:    _LLMService_IngestILOData_Handler,
		},
	},
