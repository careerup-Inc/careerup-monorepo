...
func (x *conversationServiceStreamClient) Send(m *StreamRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *conversationServiceStreamClient) Recv() (*StreamResponse, error) {
...
func (x *conversationServiceStreamServer) Send(m *StreamResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *conversationServiceStreamServer) Recv() (*StreamRequest, error) {
	m := new(StreamRequest)
...
var ConversationService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "careerup/v1/chat.proto",
}
